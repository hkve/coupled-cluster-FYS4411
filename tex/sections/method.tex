...
, then constructing $\hamhf{\alpha\beta}$ based on this and solving the eigenvalueproblem to obtain $C^{(1)}_{ii}$

repeatedly diagonalizing $C$. 

\subsubsection{Coupled Cluster}

\subsection{Closed-shell Spin Restriction}
