...
\end{align}
Where the Lagrange multipliers are diagonal since by their Hermiticity we can perform a unitary transformation to a basis where they are diagonal $\epsilon = U \epsilon' U^\dagger$.
