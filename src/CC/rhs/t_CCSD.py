...
def amplitudes_CCSD_t2(t1, t2, u, f, v, o):
    ...
    r2 += np.einsum(
        "ak,bkij->abij", t1, u[v, o, o, o], optimize=True
    )
    ...
    r2 += np.einsum(
        "ak,cj,bdil,klcd->abij", t1, t1, t2, u[o, o, v, v], optimize=True
    )
    ...
    r2 -= np.einsum(
        "ak,cl,bdij,klcd->abij", t1, t1, t2, u[o, o, v, v], optimize=True
    )

    r2 -= np.einsum(
        "bk,ci,adlj,klcd->abij", t1, t1, t2, u[o, o, v, v], optimize=True
    )
    ...
    r2 += np.einsum(
        "kc,ak,bcij->abij", f[o, v], t1, t2, optimize=True
    )

    r2 += np.einsum(
        "ak,ci,bkcj->abij", t1, t1, u[v, o, v, o], optimize=True
    )

    r2 += np.einsum(
        "ak,cj,bkic->abij", t1, t1, u[v, o, o, v], optimize=True
    )
    ...
    r2 += np.einsum(
        "ci,adkj,bkcd->abij", t1, t2, u[v, o, v, v], optimize=True
    )
    ...
    r2 += np.einsum(
        "ck,bdij,akcd->abij", t1, t2, u[v, o, v, v], optimize=True
    )

    r2 += np.einsum(
        "ak,cdij,bkcd->abij", t1, t2, u[v, o, v, v], optimize=True
    ) / 2
    ...
    r2 -= np.einsum(
        "cj,bdik,akcd->abij", t1, t2, u[v, o, v, v], optimize=True
    )
    ...
    r2 += np.einsum(
        "ak,ci,dj,bkcd->abij", t1, t1, t1, u[v, o, v, v], optimize=True
    )
    ...
    r2 -= np.einsum(
        "ak,bcil,klcj->abij", t1, t2, u[o, o, v, o], optimize=True
    )

    r2 -= np.einsum(
        "bk,aclj,klic->abij", t1, t2, u[o, o, o, v], optimize=True
    )
